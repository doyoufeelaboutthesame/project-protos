...
const file_proto_task_proto_rawDesc = "" +
	...
	"\tListTasks\x12\x16.task.ListTasksRequest\x1a\x17.task.ListTasksResponseB<Z:github.com/doyoufeelaboutthesame/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_proto_depIdxs = []int32{
	...
	5, // 5: task.TaskService.DeleteTask:input_type -> task.DeleteTaskRequest
	...
	8, // 10: task.TaskService.DeleteTask:output_type -> task.Empty
	7, // 11: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
