...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.User\x122\n" +
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\v.user.EmptyB<Z:github.com/doyoufeelaboutthesame/project-protos/proto/userb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	6, // 8: user.UserService.DeleteUser:output_type -> user.Empty
